 ...
 * @constructor
 */
function RDataContext(user, id, name, parentContextId, timeStarted, data, status, contextDataVersion, gameVersion){
    var self = this;
    self._id = id;
    self.name = name;
...
function RDataContextController(server){
    ...
    self.startContext = function startContext(user, contextId, contextName, parentContextId, timeStarted, data, contextDataVersion, callback){
        var context = new RDataContext(user, contextId, contextName, parentContextId, timeStarted, data, contextStatusStarted, contextDataVersion, user.connection.gameVersion);
